...
import { FaUser, FaPhone, FaIdCard, FaCar, FaMapMarkerAlt, FaTaxi } from 'react-icons/fa';
...
const DriverRegistration = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Replace with backend submission logic
  };
        ...
        >
          ...
          <div className="col-span-1 sm:col-span-2">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                type="submit"
                className="w-full bg-purple-600 hover:bg-purple-700 text-white text-xl font-semibold py-3 rounded-2xl shadow-lg transition duration-300"
              >
                Register Now
              </Button>
            </motion.div>
